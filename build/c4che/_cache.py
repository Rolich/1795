...
EXAMPLE_DIRECTORIES = ['error-model', 'socket', 'realtime', 'ipv6', 'energy', 'matrix-topology', 'stats', 'routing', 'tcp', 'udp', 'naming', 'tutorial', 'wireless', 'udp-client-server']
...
cfg_files = ['/home/alex/MoReV2X/build/ns3/config-store-config.h', '/home/alex/MoReV2X/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
